    ...
    return (
        <Grid background="blue" sectionType="skills">
            ...
            <div className="skills-container">
                ...
                {/* ✅ Upcoming Column */}
                <div className="skills-column">
                    <TextBox text="Upcoming" textType="h3" sectionType="skills-upcoming" />
                ...
                <div className="skills-column">
                    ...
                    <TextBox text="Concept development" textType="p" sectionType="skills" />
                    <TextBox text="Agile methodology" textType="p" sectionType="skills" />
                    <TextBox text="Hyper Island toolbox" textType="p" sectionType="skills" />
                </div>
            </div>
        </Grid>
    );
