  ...
  return (
    <Grid background="white" sectionType="contact">
      ...
      <div className="contact-info">
        ...
        <TextBox
          text="Estefanny Moran Aguilera"
          textType="h3"
          sectionType="contact"
        />
        <TextBox
          text="+46(0)763 12 33 45"
          textType="h3"
          sectionType="contact"
        />
      ...
      <div className="ticker-tape">
        <h3>
          Estefanny Morán • Fullstack Developer • Estefanny Morán • Fullstack
          Developer • Estefanny Morán • Fullstack Developer • Estefanny Morán •
          Fullstack Developer • Estefanny Morán • Fullstack Developer •
          Estefanny Morán • Fullstack Developer • Estefanny Morán
        </h3>
      </div>
    </Grid>
  );
